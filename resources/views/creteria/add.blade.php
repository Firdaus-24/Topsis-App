        ...
        <div class="col-lg-12 mt-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ url('creteria') }}" method="POST" onsubmit="return formGudang()">
                        @csrf
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    @enderror"d
                                        ...
                                        <option value="COST" {{ old('txttype') == 'COST' ? 'selected' : '' }}>COST
                                        </option>
                                        <option value="BENEFIT" {{ old('txttype') == 'BENEFIT' ? 'selected' : '' }}>BENEFIT
                                        </option>
